...
void GCodeQueue::advance() {
  ...
  void GCodeQueue::report_buffer_statistics() {
    SERIAL_ECHOLNPGM("M599"
      " Plan:", planner.moves_free(),         " ", -planner_buffer_underruns, " (", max_planner_buffer_empty_duration, ")"
      " Cmd:", BUFSIZE - ring_buffer.length, " ", -command_buffer_underruns, " (", max_command_buffer_empty_duration, ")"
    );
